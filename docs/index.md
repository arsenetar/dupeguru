...
1. **[Getting Started Guide](file:///Users/tinle/src/tinle/opensource/dupeguru/docs/getting_started.md)**
   A comprehensive overview of system requirements, dependencies installation, building from source, launching both the desktop application and the HTML Web Console, duplicate matching concepts, and configuration paths.

2. **[Architecture & Design Patterns](file:///Users/tinle/src/tinle/opensource/dupeguru/docs/architecture.md)**
...
3. **[Component Catalog](file:///Users/tinle/src/tinle/opensource/dupeguru/docs/components.md)**
...
4. **[Data Flow Analysis](file:///Users/tinle/src/tinle/opensource/dupeguru/docs/data_flow.md)**
