...
help:
	...
	@echo "  all            Build all components (virtualenv, i18n, C modules, Rust engine)"
	@echo "  run            Run the de-dup native desktop application (pywebview shell)"
	@echo "  desktop        Run the de-dup native desktop application (pywebview shell)"
